...
if(article){
 ...
 css('articleReader','/vivekadrishti/assets/css/article-reader.css?v=20260916-3');
 if(!scripture)css('articlePager','/vivekadrishti/assets/css/article-pager.css?v=20260914-2');
 if(citation||scripture)css('articlePolish','/vivekadrishti/assets/css/article-polish.css?v=20260916-3');
