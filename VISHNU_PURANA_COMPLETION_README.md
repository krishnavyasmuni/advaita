...
| Field | Current state |
|---|---|
| Last committed route | Book 2, Chapter 6 (source-aligned remediation) |
...
| Book 2 status | IN PROGRESS — Chapters 1–6 are repaired and verified; Chapters 7–16 require the same complete source-aligned repair |
| Book 3 status | REPAIRED AND VERIFIED — Chapters 1–18 have passed the complete source-aligned chapter audit |
| Current repair target | Book 2, Chapter 7 |
| Next chapter after the repair target | Book 2, Chapter 8 |
...
| Full-scope remediation queue | Book 2 Chapters 7–16; then Book 1 Chapters 1–22 |
