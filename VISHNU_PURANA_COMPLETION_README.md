...
| Field | Current state |
|---|---|
| Last committed route | Book 3, Chapter 4 (natural-translation and lexical/commentary rebuild; committed content read back exactly) |
...
| Book 3 status | INCOMPLETE — Chapters 5–12 still require the full Chapter 2 quality standard; Chapters 1–4 and 13–18 have passed full lexical/commentary rebuild or source-alignment verification and post-commit read-back |
| Current repair target | Book 3, Chapter 5 — inspect the existing chapter against the exact-source, complete-translation, genuine word-for-word, and Śrīdhara-commentary workflow |
...
| Full-scope remediation queue | Fully audit/rebuild Book 3 Chapters 5–12, then run the full Book 3 audit and rendered-page verification; only after that continue to Book 2 |
| Latest chapter verification commit | 85399535f05eb4da5b3a976ddfb40c3dbbf585c9 — Book 3 Chapter 4 natural-translation and lexical/commentary rebuild; committed content read back exactly |
| Latest semantic audit | Book 3 Chapter 4 — 26 verses, 26 translations, 26 distinct main lexical sections, 21 supplied Śrīdhara blocks, 5 exact no-commentary articles, zero raw/filler markers, 26/26 source-aligned verses, and corrected commentary range 20–21 |
...
- Chapters 1–4 and 13–18 have now passed full lexical/commentary rebuild or source-alignment verification and post-commit read-back. Chapter 1 has 46 verses and 15 supplied Śrīdhara blocks; Chapter 2 has 62 verses and three documented source-file text corrections; Chapter 3 has 31 verses, 12 exact no-commentary articles, and an explicit verse-31 source-reading/numbering note; Chapter 4 has 26 verses, 21 supplied Śrīdhara blocks, and a corrected 20–21 commentary range; Chapter 18 has 105 verses and 54 supplied Śrīdhara blocks. Chapters 5–12 still require the same source and semantic audit. Do not mark Book 3 complete until Chapters 5–12 also pass.
...
witness. The remaining documented cases include Book 3 Chapters 5–12 and the previously noted Book 2 cases (Chapters 2, 6, and 12). The next semantic pass starts at Book 3 Chapter 5 and must
