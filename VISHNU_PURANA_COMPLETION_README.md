...
| Field | Current state |
|---|---|
| Last committed route | Book 3, Chapter 4 (existing 26-article route audited, its documented 20–21 commentary range verified, and read back exactly; Chapter 7 was the latest edited route) |
...
| Book 3 status | INCOMPLETE — Chapters 18 through 4 have passed the current WFW/source/commentary/read-back audit; the reverse audit continues from Chapter 3 through Chapter 1, with the queued chapters still requiring the current Chapter 2 quality standard |
| Current repair target | Book 3, Chapter 3 — audit and rebuild against the exact-source, natural-translation, genuine word-for-word, and Śrīdhara-commentary workflow |
| Next chapter after the repair target | Book 3, Chapter 2, continuing backward through Chapter 1 before the final Book 3 audit |
...
| Full-scope remediation queue | Reverse-audit/rebuild Book 3 Chapters 3–1 under the current workflow before the final Book 3 audit and rendered-page verification |
...
| Latest semantic audit | Book 3 Chapter 4 — 26 verses, 26 translations, 26 main WFW blocks, 26 transliterations, 21 supplied Śrīdhara WFW/commentary blocks, 5 exact no-commentary articles, documented 20–21 commentary-range handling verified, no raw source-label contamination, controls balanced, and existing content read back exactly |
...
witness. The remaining reverse-work queue includes Book 3 Chapters 3–1 and the previously noted Book 2 cases (Chapters 2, 6, and 12). The next semantic pass starts at Book 3 Chapter 3 and must
