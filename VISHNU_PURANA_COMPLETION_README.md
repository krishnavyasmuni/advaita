...
| Field | Current state |
|---|---|
| Last committed route | Book 5 Chapters 22, 24, 27, 28, 29, 31, 32, and 33 rebuilt; all seven chapters reread remotely, with supplied Śrīdhara layers attached where present |
...
| Book 5 status | AUDITED structurally — 1,517 articles; 420 WFW controls, 1,097 main WFW layers still missing |
| Book 6 status | AUDITED structurally — 498 articles; 0 WFW controls, 498 main WFW layers still missing |
| Current repair target | Rebuild 3,174 missing main WFW articles from the cited Vasuki Sanskrit, chapter by chapter |
...
| Full-scope remediation queue | OPEN — 3,174 main WFW articles remain; the VP WFW markup is standardized to the verified one-mapping-per-line layout |
| Latest chapter verification commit | 5fc99811bfc72e4a4de1d581478c6dffc8ba73a6 — Book 5 Chapter 33 reread remotely with 53/53 main WFW and 25 supplied Śrīdhara units |
| Latest semantic audit | 2026-09-22 full-corpus audit — 126 routes and 6,400 articles; 3,226 WFW controls present and 3,174 main WFW layers still missing; VP controls now use the one-mapping-per-line layout; no source-range labels or leading markers remain |
