...
Audited commit: `5fc99811bfc72e4a4de1d581478c6dffc8ba73a6`
...
A WFW control exists for 3,226 of 6,400 articles. 3,174 articles still do not have a main-text lexical layer:
...
The repository contains 3,464 articles with a Śrīdhara Sanskrit control and 2,979 explicit `No commentary.` states after the Chapter 33 rebuild. The structural control check confirms that the published Transliteration controls are present, but it does not prove that every IAST string or every Śrīdhara translation is semantically correct.
...
This audit therefore records the site as structurally repaired in the areas above but semantically incomplete for the remaining 3,174 main WFW articles. Chapter-by-chapter lexical rebuilding remains open.
