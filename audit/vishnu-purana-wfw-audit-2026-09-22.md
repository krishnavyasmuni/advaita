...
Audited commit: `a9ce67faca14f8a559b8cfd327cfade0fb7321d8`
...
A WFW control exists for 3,270 of 6,400 articles. 3,130 articles still do not have a main-text lexical layer:
...
The repository contains 3,483 articles with a Śrīdhara Sanskrit control and 3,004 explicit `No commentary.` states after the Chapter 34 rebuild. The structural control check confirms that the published Transliteration controls are present, but it does not prove that every IAST string or every Śrīdhara translation is semantically correct.
...
This audit therefore records the site as structurally repaired in the areas above but semantically incomplete for the remaining 3,130 main WFW articles. Chapter-by-chapter lexical rebuilding remains open.
