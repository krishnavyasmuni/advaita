...
Audited commit: `ce81ecdd3e255920a8c6fdcc5eae5c9f2abc00e7`
...
A WFW control exists for 3,407 of 6,400 articles. 2,993 articles still do not have a main-text lexical layer:
...
The repository contains 3,534 articles with a Śrīdhara Sanskrit control and 3,090 explicit `No commentary.` states after the Chapter 37 rebuild. The structural control check confirms that the published Transliteration controls are present, but it does not prove that every IAST string or every Śrīdhara translation is semantically correct.
...
This audit therefore records the site as structurally repaired in the areas above but semantically incomplete for the remaining 2,993 main WFW articles. Chapter-by-chapter lexical rebuilding remains open.
